...
function ProductItem({product, quantity, onQuantityChange, variant, isFirst}) {
  ...
  return (
    <PaiProdStyled $variant={variant} ref={paiProdRef} isFirst={isFirst}>
